...
inputdir = sys.argv[1]          #main directory
fasta_dir = inputdir+"fasta/"
blast_dir = inputdir+"blasts/"
distance_matrix_file = inputdir+"editdistance_matrix.csv"      
...
for i in range(0, genome_count):
    for j in range(i+1, genome_count):
        ...
        mutation_values.append(distance_from_genes)
