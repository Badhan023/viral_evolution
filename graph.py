...
class Graph:
    ...
    def draw_general_graph(self, figure):
        ...
        nx.draw_networkx_nodes(self.G, pos, nodelist=self.nodes, node_color='skyblue', edgecolors='gray')
    ...
    def draw_graph(self, figure, lineage_groups):
        ...
        nx.draw_networkx_nodes(self.G, pos, nodelist=self.nodes, node_color=colors_by_nodes, edgecolors='gray')
        nx.draw_networkx_labels(self.G, pos, font_size=8)
