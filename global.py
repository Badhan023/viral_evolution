...
metadata = sys.argv[1]              #the metadata of the genomes to insert
genome_dir = sys.argv[2]            #the directory with all the genomes to insert

distance_matrix_file = sys.argv[3]       #the distance matrix
output_dir = sys.argv[4]            #the output directory
mode = sys.argv[5]                  #ani or editdistance
...
for strain in strains:
    temp={}
    for j in range(0,i):
        temp[strains[j]]=distance_matrix[i][j]
    matrix[strain]=temp
    i+=1
